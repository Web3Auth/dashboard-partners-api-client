...
import { Response, GetOrganizationsResponse, ErrorResponse, CreateProjectRequest, CreateProjectResponse, GetProjectResponse, GetProjectsResponse, UpdateProjectRequest, GetWhitelistsResponse, CreateWhitelistRequest, DeleteWhitelistRequest, GeneralResponse, GetChainNamespacesResponse } from "./types";
...
async function getChainNamespaces() {
  ...
  try {
      ...
      console.log("getChainNamespaces - response:", res.status, res.data.chain_namespaces);
  } catch (error) {
    const errorData = (error as AxiosError).response?.data as ErrorResponse;
